  ...
  <div className="leaderboard-board" style={{ 
    ...
    <div className="leaderboard-content">
      ...
      <div className="column">
        ...
        <ol>
          {wins.map((w, index) => (
            (w.userName && w.wins!==0) && <li key={index} className='chalk'>{index+1}. {w.userName} - {w.wins}</li>
          ))}
        </ol>
      </div>
      ...
      <div className="column">
        ...
        <ol>
          {scores.map((s, index) => (
            (s.userName &&  s.highestScore!==-1) && <li key={index} className='chalk'>{index+1}. {s.userName} - {s.highestScore}</li>
          ))}
        </ol>
      </div>
    </div>
